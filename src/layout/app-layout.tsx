...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'account-manager', 'finance-team-member', 'sales-representative'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Invoice', path: '/invoices', entity: 'invoice', service: AccessServiceEnum.PROJECT, icon: FiFileText },
